...
import com.example.lines.model.Generator.Generator;
import com.example.lines.model.Generator.RandomGenerator;
...
public class Model {
    public static final int MIN_CELLS_IN_CHAIN = 3;
    public static final int NEXT_COLORS_NUM = 4;
    ...
    public Model(int fieldSize) throws InvalidFieldSizeException {
        if (fieldSize < 5) {
        ...
        nextColors = generator.generateNextColors();
    ...
    private void putNextColorsAndGenerateNew() {
        List<Position> freePositions = generator.choosePositions(field.getFreePositions());
